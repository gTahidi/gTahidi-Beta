    ...
    <div className="max-w-2xl lg:max-w-5xl mx-auto py-8">
        ...
        <div className="flex flex-col border rounded-xl p-4 sm:p-6 lg:p-8">
            ...
            <div className="mt-4 grid">
                <button type="submit" className="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-gtahidiPink text-white disabled:opacity-50 disabled:pointer-events-none">Send inquiry</button>
            </div>
        ...
        <div className="divide-y divide-gray-200 ">
            ...
            <div className=" flex gap-x-7 py-6">
            <svg className="flex-shrink-0 w-6 h-6 mt-1.5 text-gray-800" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m7 11 2-2-2-2"/><path d="M11 13h4"/><rect width="18" height="18" x="3" y="3" rx="2" ry="2"/></svg>
            <div className="grow">
