...
const AboutUs = () => {
  return (
    <div className='bg-blue-900 text-white p-6 px-20'> {/* Consider adjusting px-20 if too much padding on sides */}
      ...
      <div className="flex flex-col md:flex-row md:p-12 space-x-8 items-center">
        ...
        <div className="md:w-1/3 lg:w-3/5 pr-0 md:pr-20 md:mt-0"> {/* Removed md:ml-12 and adjusted pr-20 for medium screens */}
