        ...
        <div className="space-y-10">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="bg-white rounded text-black p-2 ">
              ...
              <p>
                Just like that, click create, wait for a few seconds and you
                have your Lesson Plan!
              </p>
            </div>
          </div>
          <div className="flex items-center space-x-4">
            ...
            <div className="bg-white rounded text-black p-2 ">
              ...
              <p>
                Edit, Download & Save your lesson plans, notes and Assessment
                Questions to your Schemes of work.
              </p>
            </div>
          </div>
        </div>
