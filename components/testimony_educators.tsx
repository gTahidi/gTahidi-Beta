            ...
            <div className="container px-4 py-8 mx-auto">
                ...
                <div className="grid grid-cols-1 gap-8 mx-auto mt-8 lg:grid-cols-2 xl:mt-10 max-w-5xl">
                    <div className="p-6 bg-gray-100 rounded-lg  md:p-8">
                        ...
                        Being a Kenyan CBC teacher involves a lot of paperwork and planning. GTahidi AI has lightened workload considerably and freed up more time for teachers to focus more on actual teaching.                        </p>
                        ...
                        <div className="flex items-center mt-6">
                            ...
                            <div className="mx-4">
                                <h1 className="font-semibold text-gtahidiPink">Emily Mwanzia</h1>
                    ...
                    <div className="p-6 bg-gray-100 rounded-lg ">
                        <p className="leading-loose text-gray-500 ">
                        The CBC curriculum emphasizes interactive learning and gTahidi AI helps me generate diverse learning activities quickly.                        </p>
                        ...
                        <div className="flex items-center mt-6">
                            ...
                            <div className="mx-4">
                                <h1 className="font-semibold text-gtahidiPink">Brian Okechi</h1>
                                <span className="text-sm text-gray-500">Senior teacher</span>
                            </div>
                        </div>
                    </div>
